...
///
/// \endcode
- (void)getCategoriesWithDepartmentIDS:(NSArray<NSString *> * _Nullable)departmentIDS :(void (^ _Nullable)(NSError * _Nullable, NSArray<SIQFAQCategory *> * _Nullable))completion;
...
SWIFT_CLASS("_TtC10Mobilisten14SIQVisitorFile")
...
SWIFT_CLASS("_TtC10Mobilisten17SIQVisitorMessage")
